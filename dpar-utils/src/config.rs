...
use dpar::features;
use dpar::features::{AddressedValues, DependencyEmbeddings, Embeddings, Layer, LayerLookups};
...
impl Parser {
    ...
    pub fn load_dep_embeds(&self) -> Result<(DependencyEmbeddings, DependencyEmbeddings), Error> {
